export const writtenContent = {
    ...
    about: {
        ...
        boardMembers: [
            ...
            {
                name: 'Brooke',
                bio: `Brooke started her climbing journey 7 years ago while she was attending UMD. She enjoys climbing because it pushes her to reach for new heights both physically and mentally. Another component she loves about climbing is the amazing community it comes with. Currently, Brooke holds a board position on the North Shore Vertigals and the Duluth Climbers Coalition. She is excited to keep growing in her climbing journey and make many more connections.`
            },
            {
                name: 'Colleen',
            ...
            {
                name: 'Claire',
                bio: `My name is Claire and I haven't given Taylor my bio yet.`
            },
            {
                name: 'Marta',
