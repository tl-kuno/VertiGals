    ...
    about: {
        ...
        boardMembers: [
            ...
            },
            {
                name: 'Kathryn',
                position: 'Treasurer',
                bio: `Kathryn serves as the Treasurer for the North Shore Vertigals. A Minnesota native, she started climbing in graduate school while attending Texas A&M University. While Kathryn's more of a roped climbing person, here she is getting a bouldering session in before defending her doctoral dissertation! Now a professor at UMD, Kathryn enjoys gym climbing and spends her summers running and mountain biking on the many trails in Duluth.`
            },
            {
                name: 'Andrea',
                position: 'Secretary',
            ...
            { name: 'Brooke', bio: `My name is Brooke and I haven't given Taylor my bio yet.` },
            {
                name: 'Colleen',
            ...
            { name: 'Claire', bio: `My name is Claire and I haven't given Taylor my bio yet.` },
            {
                name: 'Marta',
